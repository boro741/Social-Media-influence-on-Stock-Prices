...
<head>
<title>cUser Registration Status..</title>
          ...
          <div class="post_content">
             <%@ include file="connect.jsp" %>
                  ...
                  <%
					...
					String paramname=null,uname=null,pass=null,email=null,mno=null,addr=null,dob=null,gender=null,company=null,pincode=null,location=null,image=null,cloud=null,bin = "";
					...
					try {
						...
						FileInputStream fs1 = null;
			 			String query1="select * from cuser  where username='"+uname+"' "; 
		          ...
		          <%
					  ...
					  String atype  ="Company Account";
PreparedStatement ps=connection.prepareStatement("insert into cuser(username,password,email,mobile,address,dob,gender,company,status,image,atype) values(?,?,?,?,?,?,?,?,?,?,?)");
		          ...
		          <p class="style19">&nbsp;</p>
		          <p><a href="cUserLogin.jsp" class="style16">Back</a></p>
		          <%
