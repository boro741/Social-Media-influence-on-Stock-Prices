		  ...
		  <td  width="161" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4" >Profit Amount </div></td>
            ...
            <%
					  ...
					  int i=1,j=0,count=0;
						...
						try 
						{
							String cname=(String)application.getAttribute("ucompany");
						   	String query="select * from profit where cname='"+cname+"'"; 
            ...
            <tr>
              <td height="0"  valign="middle" bgcolor="#FFFFFF">
			 	...
			 	<td height="0"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			   <a href="A_UserProfile.jsp?uname=<%=s0%>&type=<%="userprofitdetails"%>"> <%out.println(s0);%> </a>               </div>
             	 </div></td>
			   
			    <td height="0"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			   <a href="A_C.jsp?cname=<%=s1%>&type=<%="userprofitdetails"%>"> <%out.println(s1);%> </a>               </div>
              </div></td>
...
<!-- end #content -->
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="cUserMain.jsp"><strong>Home</strong></a></li>
            <li><a href="cUserLogin.jsp"><strong>Logout</strong></a></li>
