        ...
        <h1 class="style3"><a href="#"><span class="style2">User<span class="style2"> <span class="style2"><span class="style2"> <%=request.getParameter("uname")%>'s Profile...</span><span class="style2">..</span></span></span></a></h1> 
          ...
          <table width="533" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
		   ...
		   <%String id=request.getParameter("id");%>
			...
			<%}
			else if(type.equalsIgnoreCase("usersharedetails")){%>
            <h2 align="right"><a href="A_UserShareDetails.jsp" class="style4">Back</a></h2>
			<%}
            ...
            <h2 align="right"><a href="A_TweetDetails.jsp?id=<%=id%>&type=<%=type%>&tname=<%=name%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("userprofitdetails")){%>
            <h2 align="right"><a href="cU_UserProfitDetails.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
