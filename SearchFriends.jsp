  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style4">
        <div class="article">
          <h1 class="title"><a href="#"><span class="style2"><span class="style2"><span class="style2">Search Friends.. </span></span><span class="style2"></span></span></a></h1>
        <p>&nbsp;</p>	  
	<div class="clr"></div>
          ...
          <div class="post_content">
			...
			<div class="article">
				...
				<h1 class="title"><a href="#"><span class="style2"><span class="style3"><span class="style3">Results Found.. </span></span><span class="style3"></span></span></a></h1>
				<div class="post_content"><span class="news_content">
				  <%
