  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style4">
        <div class="article">
          <h1 class="title style2 style2" ><a href="#" class="style2"><span class="style2 style2">No Of Share Holders in Each Company By Chart.....</span></a></h1>
         <p>&nbsp;</p> 
	<div class="clr"></div>
          
          <div class="post_content">
              <iframe width="550" height="400" src="ShareChart.jsp"></iframe>
