  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style4">
        <div class="article">
<h1 class="title"><a href="#"><span class="style2">User<span class="style2"> <span class="style2"><span class="style2"><%=(String)application.getAttribute("uname")%><span class="style30">'s</span></span> <span class="style30">Profile</span></span><span class="style2">..</span></span></span></a></h1>          
	<p>&nbsp;</p>
