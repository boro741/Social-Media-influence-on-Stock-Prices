  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style4">
        <div class="article">
        <h1 class="title style2 style2" ><a href="#" class="style2"><span class="style2 style2">All User's Share Details.....</span></a></h1> 
          <div class="clr"></div>
        ...
        <tr bgcolor="#99CCCC">
		 ...
		 <td  width="137" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4" >User Name</div></td>
		  ...
		  <td  width="161" height="34" valign="baseline" bgcolor="#FFFFFF" style="color: #2c83b0;"><div align="center" class="style4" >Invested Amount </div></td>
        </tr>
            ...
            <tr>
              <td height="0"  valign="middle" bgcolor="#FFFFFF">
			 	...
			 	<td height="0"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			   <a href="A_UserProfile.jsp?uname=<%=s5%>&type=<%="usersharedetails"%>"> <%out.println(s5);%> </a>               </div>
             	 </div></td>
			   
			    <td height="0"  valign="middle" bgcolor="#FFFFFF">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			   <a href="A_C.jsp?cname=<%=s0%>&type=<%="usersharedetails"%>"> <%out.println(s0);%> </a>               </div>
              </div></td>
            ...
            <%
					...
					if(count==0){out.print("User's Have Not Purchased Any Shares");}
