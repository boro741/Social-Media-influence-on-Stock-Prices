...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0"  width="600" >
				 				<tr >
								    <td width="148" rowspan="8" bgcolor="#FFFFFF" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" > 
				    			...
				    			<tr>
									<td width="128" height="41" bgcolor="#FFFFFF">
		...
		<p>&nbsp;</p>
				 <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("allmytweets")){%>
            <h2 align="right"><a href="U_AllTweetsDetails.jsp" class="style4">Back</a></h2>
			<%}
	   ...
	   <h2 align="center" class="style9">All User Comments On The Tweet </h2>
		...
		<tr>
			...
			<%}else{%>
			 ...
			 <td  width="182" height="44" valign="middle" bgcolor="#FFFFFF" style="color:#000000;">
			   <div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em><a href="U_UserProfile.jsp?uname=<%=c_user%>&type=<%=type%>&id=<%=one%>&name=<%=tname%>"> <%out.println(c_user);%> 
		    </a></em></strong></div></td>
			<%}%>
...
<%					
						...
						if(count==0){
										out.print("No User Has commented On This Tweet");
								}
