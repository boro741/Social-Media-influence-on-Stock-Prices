...
String s5=request.getParameter("com");
...
Statement st1 = connection.createStatement();
				String query1="insert into comment(tname,cname,c_user,comments,dt,tid) values('"+name+"','"+cname+"','"+user+"','"+s5+"','"+dt+"','"+one+"')";
...
//Checking For Negative Comments Starts..
				...
				if ((s5.indexOf(na1)>=0 || s5.indexOf(na2)>=0|| s5.indexOf(n1)>=0   || s5.indexOf(n2)>=0  || s5.indexOf(n3)>=0  || s5.indexOf(n4)>=0  || s5.indexOf(n5)>=0 
								...
								{								
												...
												String strQuery6 = "insert into ncomments(tname,cname,c_user,comments,dt,tid) values('"+name+"','"+cname+"','"+user+"','"+s5+"','"+dt+"','"+one+"')"; 	
							...
							//Checking For Positive Comments Starts..
								...
								if ((s5.indexOf(ta1)>=0 || s5.indexOf(ta2)>=0 
									 ...
									 || s5.indexOf(n96)>=0	|| s5.indexOf(n97)>=0 || s5.indexOf(n98)>=0 || s5.indexOf(n99)>=0 || s5.indexOf(n100)>=0))
									 {
															...
															String strQuery61 = "insert into pcomments(tname,cname,c_user,comments,dt,tid) values('"+name+"','"+cname+"','"+user+"','"+s5+"','"+dt+"','"+one+"')"; 	
			...
			int k=st1.executeUpdate (query1);
				  ...
				  {
				  				  %><br/>
<p class="style46"> Commented Successfully..</p>
								  <p class="style17"><br/>
							      <a href="U_Comment.jsp?id=<%=one%>&tname=<%=name%>&type=<%=type%>" class="style47">Back</a></p>
									<%
		...
		else
		{
								 ...
								 %><br/>
									<p class="style46">Enter Your comment !!..</p>
								    <p class="style17"><br/>
							      <a href="U_Comment.jsp?id=<%=one%>&tname=<%=name%>&type=<%=type%>" class="style47">Back</a></p>
					<%								  
		}
