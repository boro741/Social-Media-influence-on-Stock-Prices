...
<%@ page import="java.sql.*"%>
			...
			%>
			      <table width="598" border="1" align="left" cellpadding="0" cellspacing="0" >
                    <tr >
                      <td width="186" rowspan="7" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" >
		    ...
		    <tr >
                      <td height="37" ><div align="center" class="style70">Capital Investment</div></td>
...
%>
			...
			<div align="center" class="style22"><a href="cU_VT.jsp" class="style11">Back</a></div>
          </div>
          <div class="clr"></div>
        </div>
