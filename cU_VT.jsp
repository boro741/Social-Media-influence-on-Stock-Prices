  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar style4">
        <div class="article">
          <h1 class="title style2 style2" ><a href="#" class="style2"><span class="style2 style2">Company List.....</span></a></h1>
         <p>&nbsp;</p> 
	<div class="clr"></div>
          ...
          <div class="post_content">
             <table width="545" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                      <tr>
                        ...
                        <td  width="176" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style55 style52 style5 style37 style38"><strong>Company Image</strong></div></td>
                        <td  width="180" valign="middle" style="color: #2c83b0;"><div align="center" class="style52 style55 style5 style38 style37"><strong>Company Name</strong></div></td>
                      ...
                      <%
					  	String user=(String)application.getAttribute("cuname");
						...
						try 
						{
						   	...
						   	String query="select cname from company where cname='"+company+"'"; 
                      ...
                      <tr>
                        ...
                        <td align="center"  valign="middle" style="color: #2c83b0;"><div align="center" class="style22 style5 style20 style37 style54 style81">
                           
                              <%out.println(s2);%>

                        </div></td>
                        <td height="172" align="center"  valign="middle"><label>
						 <form id="form1" name="form1" method="post" action="cU_VT1.jsp">
                          <input type="hidden" value="<%=s2%>" name="cname"/>
                         	
                          <input type="submit" name="Submit" value="View Company Details" />
                          </label>  
						  </form>
					    </td>
                      </tr>
			...
			<div align="center" class="style22"><a href="cUserMain.jsp" class="style11">Back</a></div>
          </div>
          <div class="clr"></div>
        </div>
